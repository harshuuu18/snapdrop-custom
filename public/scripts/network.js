...
var inputTag = document.getElementById("ChangeName");
var inputBtn = document.getElementById("ChangeBtn");
inputBtn.addEventListener("click", () => {
  console.log(inputTag.value);
  localStorage.setItem("user", inputTag.value);
});
...
class ServerConnection {
  ...
  _connect() {
    ...
    ws.onopen = (e) => {
      console.log(`WS: server connected ${e}`);
      this.send(
        { type: "hellomsg", data: localStorage.getItem("user") },
        "hey"
      );
    };
